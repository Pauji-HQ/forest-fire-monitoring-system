...
{
    private readonly RegisterPageModel _viewModel;
    ...
    private async void OnRegisterClicked(object sender, EventArgs e)
    {
        ...
        _viewModel.StatusMessage = "Sedang mengambil gambar wajah...";
        ...
        try
        {
            ...
            if (stream == null)
            {
                _viewModel.StatusMessage = "Gagal mengambil foto wajah dari kamera.";
                _viewModel.StatusColor = Colors.Red;
            ...
            await _viewModel.RegisterUserAsync(faceBytes);
        }
        catch (Exception ex)
        {
            _viewModel.StatusMessage = $"Kesalahan sistem: {ex.Message}";
            _viewModel.StatusColor = Colors.Red;
        }
        finally
        {
